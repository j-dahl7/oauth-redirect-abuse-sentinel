...
The August 13, 2026 revision passed ten offline contract tests, including
PowerShell parsing and mocked ownership/preview behavior, immutable-App-ID rule
and hunt checks, workbook time-range binding, and documented Graph-permission checks. It
